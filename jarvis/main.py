...
def wishMe():
    ...
    if (hour >= 0) and (hour <= 12) and ('AM' in t):
        speak(f"Good morning Hareesh, it's {day} and the time is {t}")
    elif (hour >= 12) and (hour <= 16) and ('PM' in t):
        speak(f"Good afternoon Hareesh, it's {day} and the time is {t}")
    else:
        speak(f"Good evening Hareesh, it's {day} and the time is {t}")
...
def schedule():
    ...
    week = {
        "monday": "Boss, from 8:45 to 9:45 you have Middleware Technologies, from 10:45 to 11:35 you have Websphere Aplication Server, from 11:45 to 1:45 you have a break, from 1:45 to 5:45 you have a Placement Training Class.",
        "tuesday": "Boss, from 8:45 to 12:45 you have placement Training class, from 12:45 to 1:35 you have a break, and today you have Middleware Technologies from 1:45 onwards.",
